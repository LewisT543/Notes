...
Your Choice: 1
Enter Vehicle Registration string: {json string}
...etc.
'''

# Your task is to write a code which has exactly the same conversation with the user and:

    # Defines a class named Vehicle, whose objects can carry the vehicle data shown above (the structure of the class should be deducted 
        # from the provided dialog — call it "reverse engineering" if you want)
