...
# check if length is good vs country
# Move 4 chars to end of string
# replace each letter with 2 digits (ascii A=10, B=11... Z=35)
# interpret number as a decimal integer, divide by 97, if answer = 1, number is valid. Else its not.
