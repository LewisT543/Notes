...
def batteries_check():
    try:
        print('Battery Charge: {}%'.format(100/0))
    except ZeroDivisionError as e:
        raise RocketNotReadyError('Battery is fucked') from e

def circuits_check():
    try:
        print('Circuits operating at {} capacity'.format(100/0))
    except ZeroDivisionError as e:
        raise RocketNotReadyError('Circuits... Broken') from e
    pass
